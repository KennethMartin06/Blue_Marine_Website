        ...
        <Container>
          <div className="py-16 md:py-20">
            ...
            <div className="mt-10 text-sm text-black/70">
              Learn more about Blue Wave Marine on the{" "}
              <Link
                href="/about"
                className="font-medium text-[color:var(--ocean-700)] hover:text-[color:var(--ocean-600)]"
              >
                About page →
              </Link>
            </div>
